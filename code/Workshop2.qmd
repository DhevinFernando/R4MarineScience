...
This is my attempt to plot fish abundance while also visualising salinity differences on the same plot as there are notable differences between the salinities at each estuary zone:
...
#plot mean fish count as a line graph for each scientific species across each estuary zone with error bars representing the standard error
#faceted by species
#The plot will have jittered data points for count from the finalised_catch dataset
# points to be coloured by zone and sized by mean salinity. 
